...
//                System.out.println("temp.Voter: " + voter.getName() + ", Revealed Vote: " + revealedVote);
//            }
//        }
//    }
//
...
//            System.out.println("Error: temp.Voter name not found in signature.");
//            return null;
//        }
//    }
//}
...
//
//            // Create candidates
//            Candidate candidate1 = new Candidate("temp.Candidate A");
//            Candidate candidate2 = new Candidate("temp.Candidate B");
//
//            // Create voters
//            Voter voter1 = new Voter("temp.Voter 1", keyPairGenerator.generateKeyPair());
//            Voter voter2 = new Voter("temp.Voter 2", keyPairGenerator.generateKeyPair());
//            Voter voter3 = new Voter("temp.Voter 3", keyPairGenerator.generateKeyPair());
//            Voter voter4 = new Voter("temp.Voter 4", keyPairGenerator.generateKeyPair());
//
